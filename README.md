...
- 每分類一筆的 915 筆 → 全部完成
- 場上播報（球數與投球動作、球種名稱、天氣、半局結算、打者近況）→ 全部完成
- 球探報告（球威／控球／尾勁、擊球／長打／選球／速度、守備與守位、先發與牛棚定位、球員簡介）1,197 筆 → 全部完成
- 還沒翻的 1,627 筆是教練與總管評語、長篇賽後戰報與老闆信件；其中 CAT 860（季後賽戰報）一段就佔 320 筆／14.7 萬字元
